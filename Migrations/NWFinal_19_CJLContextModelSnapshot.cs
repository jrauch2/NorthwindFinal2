...
{
    [DbContext(typeof(NWFinal_19_CJLContext))]
    partial class NWFinal_19_CJLContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Northwind.Models.Discounts", b =>
                {
            ...
            modelBuilder.Entity("Northwind.Models.EmployeeTerritories", b =>
                {
            ...
            modelBuilder.Entity("Northwind.Models.Employees", b =>
                {
                    b.Property<int>("EmployeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("EmployeeID")
            ...
            modelBuilder.Entity("Northwind.Models.Orders", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("OrderID")
            ...
            modelBuilder.Entity("Northwind.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("Northwind.Models.Products", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Northwind.Models.EmployeeTerritories", b =>
                {
                    b.HasOne("Northwind.Models.Employees", "Employee")
                        .WithMany("EmployeeTerritories")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_EmployeeTerritories_Employees");

                    b.HasOne("Northwind.Models.Territories", "Territory")
                        .WithMany("EmployeeTerritories")
            ...
            modelBuilder.Entity("Northwind.Models.Employees", b =>
                {
                    b.HasOne("Northwind.Models.Employees", "ReportsToNavigation")
            ...
            modelBuilder.Entity("Northwind.Models.OrderDetails", b =>
                {
                    b.HasOne("Northwind.Models.Orders", "Order")
            ...
            modelBuilder.Entity("Northwind.Models.Orders", b =>
                {
                    ...
                    b.HasOne("Northwind.Models.Shippers", "ShipViaNavigation")
                        .WithMany("Orders")
